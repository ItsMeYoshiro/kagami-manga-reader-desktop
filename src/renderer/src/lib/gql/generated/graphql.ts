...
export type DownloadStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type DownloadStatusQuery = { downloadStatus: { state: DownloaderState, queue: Array<{ position: number, progress: number, state: DownloadState, tries: number, chapter: { id: number, name: string, chapterNumber: number, mangaId: number }, manga: { id: number, title: string, thumbnailUrl: string | null } }> } };

export type DownloadStatusChangedSubscriptionVariables = Exact<{
  maxUpdates: Scalars['Int']['input'];
}>;


export type DownloadStatusChangedSubscription = { downloadStatusChanged: { state: DownloaderState, omittedUpdates: boolean, initial: Array<{ position: number, progress: number, state: DownloadState, tries: number, chapter: { id: number, name: string, chapterNumber: number, mangaId: number }, manga: { id: number, title: string, thumbnailUrl: string | null } }> | null, updates: Array<{ type: DownloadUpdateType, download: { position: number, progress: number, state: DownloadState, tries: number, chapter: { id: number, name: string, chapterNumber: number, mangaId: number }, manga: { id: number, title: string, thumbnailUrl: string | null } } }> } };

export type EnqueueDownloadMutationVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type EnqueueDownloadMutation = { enqueueChapterDownload: { downloadStatus: { state: DownloaderState } } | null };

export type EnqueueDownloadsMutationVariables = Exact<{
  ids: Array<Scalars['Int']['input']> | Scalars['Int']['input'];
}>;


export type EnqueueDownloadsMutation = { enqueueChapterDownloads: { downloadStatus: { state: DownloaderState } } | null };

export type DequeueDownloadsMutationVariables = Exact<{
  ids: Array<Scalars['Int']['input']> | Scalars['Int']['input'];
}>;


export type DequeueDownloadsMutation = { dequeueChapterDownloads: { downloadStatus: { state: DownloaderState } } | null };

export type DeleteDownloadsMutationVariables = Exact<{
  ids: Array<Scalars['Int']['input']> | Scalars['Int']['input'];
}>;


export type DeleteDownloadsMutation = { deleteDownloadedChapters: { chapters: Array<{ id: number, isDownloaded: boolean }> } | null };
...
export type ExtensionStoresQuery = { extensionStores: { nodes: Array<{ name: string, indexUrl: string, badgeLabel: string, isLegacy: boolean, contactWebsite: string }> } };
...
export type AddExtensionStoreMutation = { addExtensionStore: { extensionStore: { name: string, indexUrl: string, badgeLabel: string } } | null };

export type ExtensionsQueryVariables = Exact<{ [key: string]: never; }>;


export type ExtensionsQuery = { extensions: { nodes: Array<{ pkgName: string, name: string, lang: string, versionName: string, iconUrl: string, isInstalled: boolean, isObsolete: boolean, hasUpdate: boolean, contentWarning: ContentWarning, storeIndexUrl: string | null }> } };

export type FetchExtensionsMutationVariables = Exact<{ [key: string]: never; }>;


export type FetchExtensionsMutation = { fetchExtensions: { extensions: Array<{ pkgName: string }> } | null };
...
export type UpdateExtensionMutation = { updateExtension: { extension: { pkgName: string, isInstalled: boolean, hasUpdate: boolean, versionName: string } | null } | null };

export type LibraryQueryVariables = Exact<{ [key: string]: never; }>;


export type LibraryQuery = { mangas: { nodes: Array<{ id: number, title: string, thumbnailUrl: string | null, unreadCount: number, downloadCount: number, chapters: { totalCount: number }, lastReadChapter: { id: number, name: string } | null }> } };

export type SetInLibraryMutationVariables = Exact<{
  id: Scalars['Int']['input'];
  inLibrary: Scalars['Boolean']['input'];
}>;


export type SetInLibraryMutation = { updateManga: { manga: { id: number, inLibrary: boolean } } | null };

export type LibraryUpdateStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type LibraryUpdateStatusQuery = { lastUpdateTimestamp: { timestamp: string }, libraryUpdateStatus: { jobsInfo: { isRunning: boolean, totalJobs: number, finishedJobs: number, skippedMangasCount: number, skippedCategoriesCount: number } } };

export type LibraryUpdateStatusChangedSubscriptionVariables = Exact<{
  maxUpdates: Scalars['Int']['input'];
}>;


export type LibraryUpdateStatusChangedSubscription = { libraryUpdateStatusChanged: { omittedUpdates: boolean, jobsInfo: { isRunning: boolean, totalJobs: number, finishedJobs: number, skippedMangasCount: number, skippedCategoriesCount: number }, mangaUpdates: Array<{ status: MangaJobStatus, manga: { id: number, title: string } }> } };

export type UpdateLibraryMutationVariables = Exact<{ [key: string]: never; }>;


export type UpdateLibraryMutation = { updateLibrary: { updateStatus: { jobsInfo: { isRunning: boolean, totalJobs: number, skippedMangasCount: number } } } | null };

export type StopUpdateMutationVariables = Exact<{ [key: string]: never; }>;


export type StopUpdateMutation = { updateStop: { clientMutationId: string | null } };

export type UpdateSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type UpdateSettingsQuery = { settings: { excludeUnreadChapters: boolean, excludeNotStarted: boolean, excludeCompleted: boolean } };

export type SetUpdateSettingsMutationVariables = Exact<{
  excludeUnreadChapters?: InputMaybe<Scalars['Boolean']['input']>;
  excludeNotStarted?: InputMaybe<Scalars['Boolean']['input']>;
  excludeCompleted?: InputMaybe<Scalars['Boolean']['input']>;
}>;
...
export type SetUpdateSettingsMutation = { setSettings: { settings: { excludeUnreadChapters: boolean, excludeNotStarted: boolean, excludeCompleted: boolean } } };
...
export type MangaDetailQuery = { manga: { id: number, title: string, author: string | null, artist: string | null, description: string | null, genre: Array<string>, status: MangaStatus, thumbnailUrl: string | null, realUrl: string | null, inLibrary: boolean, initialized: boolean, unreadCount: number, downloadCount: number, source: { id: string, displayName: string } | null, chapters: { nodes: Array<{ id: number, name: string, chapterNumber: number, scanlator: string | null, uploadDate: string, isRead: boolean, isBookmarked: boolean, isDownloaded: boolean, lastPageRead: number, pageCount: number, sourceOrder: number }> } } };

export type FetchMangaAndChaptersMutationVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type FetchMangaAndChaptersMutation = { fetchMangaAndChapters: { manga: { id: number, initialized: boolean } } | null };
...
export type UpdateChapterMutation = { updateChapter: { chapter: { id: number, isRead: boolean, isBookmarked: boolean, lastPageRead: number } } | null };
...
export type FetchChapterPagesMutation = { fetchChapterPages: { pages: Array<string>, chapter: { id: number, pageCount: number, lastPageRead: number } } | null };

export type ReaderChapterQueryVariables = Exact<{
  chapterId: Scalars['Int']['input'];
}>;


export type ReaderChapterQuery = { chapter: { id: number, name: string, chapterNumber: number, pageCount: number, lastPageRead: number, isRead: boolean, mangaId: number, manga: { id: number, title: string, chapters: { nodes: Array<{ id: number, name: string, chapterNumber: number, sourceOrder: number }> } } } };
...
export type SaveProgressMutation = { updateChapter: { chapter: { id: number, lastPageRead: number, isRead: boolean } } | null };

export type SourcesQueryVariables = Exact<{ [key: string]: never; }>;


export type SourcesQuery = { sources: { nodes: Array<{ id: string, name: string, displayName: string, lang: string, iconUrl: string, isNsfw: boolean, supportsLatest: boolean, extension: { pkgName: string } }> } };

export type SearchSourceMutationVariables = Exact<{
  source: Scalars['LongString']['input'];
  query: Scalars['String']['input'];
  page: Scalars['Int']['input'];
}>;
...
export type SearchSourceMutation = { fetchSourceManga: { hasNextPage: boolean, mangas: Array<{ id: number, title: string, thumbnailUrl: string | null, inLibrary: boolean, status: MangaStatus }> } | null };

export type PopularSourceMutationVariables = Exact<{
  source: Scalars['LongString']['input'];
  page: Scalars['Int']['input'];
}>;


export type PopularSourceMutation = { fetchSourceManga: { hasNextPage: boolean, mangas: Array<{ id: number, title: string, thumbnailUrl: string | null, inLibrary: boolean, status: MangaStatus }> } | null };
